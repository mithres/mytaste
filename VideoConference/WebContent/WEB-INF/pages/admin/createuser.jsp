...
<s:form namespace="/admin" action="createUser">
	...
	<s:textfield label="User Name" name="user.userName" value="" />
	<s:password label="User Password" name="user.password" value=""/>
	...
	<s:select label="Roles" name="user.roles" list="roles" listKey="roleId" listValue="roleName" multiple="true" required="true" />
