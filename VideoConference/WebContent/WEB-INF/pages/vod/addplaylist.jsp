...
<s:form namespace="/vod" action="savePlayList">
	<s:textfield label="FileName" name="playList.fileName" />
	<s:textfield label="ScreenShot" name="playList.screenShot" />
	...
	<s:textarea label="Description" cols="40" rows="6" name="playList.description" />
	<s:submit label="Save"/>
