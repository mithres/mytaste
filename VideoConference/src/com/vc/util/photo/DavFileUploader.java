...
public class DavFileUploader implements IFileUploader {
	...
	private static Logger log = Red5LoggerFactory.getLogger(DavFileUploader.class, "VideoConference");
	 ...
	 * 
	 * @see
	 * com.comodo.hopsurf.toolbar.image.FileUploader#preparePath(java.lang.String
	 * )
	 */
	@Override
