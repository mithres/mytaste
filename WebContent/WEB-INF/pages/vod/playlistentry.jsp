...
<s:iterator value="videos.records">
	<ul class="video_s">
		...
		<li class="playMenu" id="<s:property value="type"/><s:property value="id"/>"><img onclick="addToQueue('<s:property value="id"/>');" onmouseout="this.src='<web.page:path/>/images/qls.gif'" onmouseover="this.src='<web.page:path/>/images/qlh.gif'" title="Add this video to your queue" style="display: block;" src="<web.page:path/>/images/qls.gif"></li>
		<li class="videoName">
