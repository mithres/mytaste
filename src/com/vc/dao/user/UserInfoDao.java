...
public class UserInfoDao extends GenericDAO<UserInfo, String> {
	...
	private static final String FIND_USER_BY_INDEX = " from UserInfo where userIndex = ? ";

	public UserInfo findUserByIndex(long userIndex) {
		return (UserInfo) this.findUnique(FIND_USER_BY_INDEX, new Hints(0), userIndex);
	}
